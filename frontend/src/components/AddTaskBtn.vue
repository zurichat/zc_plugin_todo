<template>
    <button class="td-bg-green-500 td-my-5 td-flex td-items-center td-p-4 td-rounded-md td-text-white">
...
<<<<<<< HEAD:resources/js/components/AddTaskBtn.vue
        <span class="px-2">Create a New Todo</span>
=======
        <span class="td-px-2">Create New Todo</span>
>>>>>>> f2362dccbdcd57d4cba59e4cb8e0f81e00e67a6c:frontend/src/components/AddTaskBtn.vue
    </button>
</template>
<script>
export default {
