...
<div class="td-w-full td-flex-grow ">
  <div id="Details" class="">
    ...
    <div class="sub-header td-flex td-py-3 td-justify-between td-items-center td-border-b-2">
      <div class="td-flex"> 
        <div class="mr-2 font-bold button td-px-4 td-py-2 td-bg-green-500 td-cursor-pointer td-rounded td-text-white" @click="toggleModal">+ Add a new Task</div>
  ...
  <AddTaskForm v-if="isModal===false" v-on:toggleModal="toggleModal" />
