    ...
    >
      ...
      <div class="form-group td-flex td-flex-col pb-4">
        ...
        <input
          ...
          class="
            td-border
            hover:td-border-green-400
            td-bg-white td-py-3 td-outline-none td-text-md td-w-full td-px-2 td-rounded
          "
      ...
      <div class="form-group td-flex td-flex-col td-pb-4">
        ...
        <div class="td-flex td-items-center">
          <span class="td-text-gray-500 td-px-2">Click to make task a recurring task: </span>
          <Checkbox
            id="binary"
            v-model="checked"
            :binary="true"
            @change="
              form_data.recurring == 0 ? (form_data.recurring = 1) : (form_data.recurring = 0)
            "
          />
        </div>
      </div>
      ...
      <div class="cta-container">
        <button
          class="
            submit
            td-bg-green-500 td-py-3 td-px-4 td-rounded td-text-white td-font-bold td-float-right
          "
          type="submit"
        >
          Create task
