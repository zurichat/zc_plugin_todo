<template>
  <div
    id="TodoCard"
    class="
      td-px-4 td-py-2 td-mx-auto td-border td-rounded td-cursor td-my-4
      sm:td-my-0
      taskcard
      sm:td-mx-0
      td-relative
    ...
    <div>
      <div class="td-flex td-justify-between">
        <div id="card_title td-py-3">
          ...
          <p class="description td-text-gray-500 td-text-sm">{{ description }}...</p>
        </div>
      </div>
      <hr class="td-mt-4" />
      <div id="progress_container">
        <progress id="progress" class="td-w-full td-mx-auto" :value="percent" max="100">
          32%
        </progress>
        <div id="task_preview" class="td-flex">
          <div class="mark_icon">
            ...
            >
              ...
              <path
                d="M13.5 6.6875L7.3125 12.875L4.5 10.0625"
                stroke="white"
          ...
          <p
            id="details"
            class="td-flex td-px-2 td-items-center td-text-gray-600 td-font-semibold td-text-sm"
          >
            {{ completedTask.length }}/{{ todo.tasks.length }} tasks ({{ percent + "%" }} Completed)
          </p>
        </div>
      </div>
      <div id="date_container" class="td-flex td-my-2 td-items-center">
        ...
        <span class="td-text-gray-500 td-font-bold td-px-2">
          ...
          >
            <path
              d="M0.04 2.025C0.04 1.76833 0.0883334 1.52667 0.185 1.3C0.285 1.07333 0.418333 0.876667 
              0.585 0.71C0.751667 0.54 0.946667 0.406666 1.17 0.31C1.39667 0.21 1.63667
               0.16 1.89 0.16C2.14667 0.16 2.38833 0.21 2.615 0.31C2.84167 0.406666
                3.03833 0.54 3.205 0.71C3.375 0.876667 3.50833 1.07333 3.605 1.3C3.705
                 1.52667 3.755 1.76833 3.755 2.025C3.755 2.28167 3.705 2.52333 3.605
                  2.75C3.50833 2.97333 3.375 3.16833 3.205 3.335C3.03833 3.50167 2.84167
                   3.635 2.615 3.735C2.38833 3.83167 2.14667 3.88 1.89 3.88C1.63667 3.88
                    1.39667 3.83167 1.17 3.735C0.946667 3.635 0.751667 3.50167 0.585 3.335C0.418333
                     3.16833 0.285 2.97333 0.185 2.75C0.0883334 2.52333 0.04 2.28167 0.04 2.025Z"
              fill="#616061"
            />
          </svg>
        </span>
      ...
      <div class="td-flex td-justify-between td-mt-4 td-items-center">
        <div id="collaborators" class="td-flex td-border td-rounded-md td-items-center">
          ...
          <span class="td-mx-0.5 td-h-6 td-rounded td-px-2 td-py-1 td-text-xs td-select-none"
            >20</span
          >
        </div>
        <div id="todo_link" @click="details()">
          <span class="td-underline td-cursor-pointer td-font-medium td-text-green-400"
            >View Task</span
          >
        </div>
      </div>
